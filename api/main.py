...
from routers import auth, search, download, devices, playlists, tagger, settings, songs, guest, discovery, library, context, update
...
app.include_router(guest.router, prefix="/api/auth", tags=["auth"])
