...
<div class="guest-banner">
  ...
  {#if showModal}
    <div class="modal-overlay" onclick={closeModal} role="presentation">
      <div class="modal-content" role="dialog" aria-modal="true" aria-label="About omniMux" tabindex="-1">
        <button class="modal-close" aria-label="Close" onclick={() => (showModal = false)}>
