...
<div class="player" class:inactive={!isActivePlayer}>
  ...
  <div class="player-controls">
    <div class="player-buttons">
      ...
      <button class="control-btn" onclick={playPrev} title="Previous">
  ...
  <div class="player-volume">
    ...
    <button class="control-btn mute-btn" onclick={toggleMute} title={$volume > 0 ? 'Mute' : 'Unmute'} aria-label={$volume > 0 ? 'Mute' : 'Unmute'}>
      {#if $volume > 0}
